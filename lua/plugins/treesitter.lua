...
sel("af", "@function.outer", "整个函数")
sel("if", "@function.inner", "函数体")
sel("ac", "@class.outer", "整个类")
sel("ic", "@class.inner", "类体")
sel("aa", "@parameter.outer", "参数(含分隔符)")
sel("ia", "@parameter.inner", "参数")
...
mv("]f", "goto_next_start", "@function.outer", "下个函数")
mv("[f", "goto_previous_start", "@function.outer", "上个函数")
